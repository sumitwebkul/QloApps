...
return array(
	...
	'translations' => array(
		...
		'The required PHP version is between 8.0 to 8.4.1' => 'The required PHP version is between 8.0 to 8.4.1',
		...
		'You are using PHP %s version. Soon, the latest PHP version supported by QloApps will be PHP 8.0. To make sure you’re ready for the future, we recommend you to upgrade to PHP 8.0 now!' => 'You are using PHP %s version. Soon, the latest PHP version supported by QloApps will be PHP 8.0. To make sure you’re ready for the future, we recommend you to upgrade to PHP 8.0 now!',
