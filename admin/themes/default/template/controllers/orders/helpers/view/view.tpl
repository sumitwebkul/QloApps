...
{block name="override_tpl"}
    ...
    <div id="order_detail_view">
                                            ...
                                            {foreach from=$htl_booking_order_data item=data}
                                                {if !$data.is_refunded}
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="open_room_status_form" href="#">
                                                                {l s='Edit Status'}
                                                            </a>
                                                        </td>
                                                    </tr>
        ...
        <div class="modal fade order_detail_modal" id="mySwappigModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        ...
        <div class="modal order_detail_modal" tabindex="-1" role="dialog" id="rooms_type_extra_demands">
            <div class="modal-dialog" role="document">
